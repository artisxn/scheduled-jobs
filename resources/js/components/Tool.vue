...
export default {
    ...
    methods: {        
        ...
        confirmDispatchJob() {
            ...
            Nova.request().post('/nova-vendor/codicastudio/scheduled-jobs/dispatch-job', { command: job.command })
                .then((response) => {                    
        ...
        fetchJobs() {
            ...
            Nova.request().get('/nova-vendor/codicastudio/scheduled-jobs/jobs').then((response) => {
                this.loading = false
